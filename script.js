document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStoreUI(isOpen) {
        ...
        // Disable ordering if closed - but admin can still access
        document.querySelectorAll('.add-to-cart').forEach(btn => {
            btn.disabled = !isOpen;
        });
        
        checkoutBtn.disabled = !isOpen || checkoutBtn.disabled;
    }
    ...
    function renderMenu() {
        ...
        menuItems.forEach(item => {
            ...
            menuItemEl.innerHTML = `
                ...
                <div class="menu-item-content">
                    ...
                    <button class="add-to-cart" data-id="${item.id}" ${!item.available || !storeHours.isOpen ? 'disabled' : ''}>
        ...
        document.querySelectorAll('.add-to-cart').forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (item && item.available && storeHours.isOpen) {
                    addToCart(item);
                }
            });
        });
    ...
    function updateCheckoutButton() {
        ...
        checkoutBtn.disabled = cart.length === 0 || name === '' || phone === '' || !storeHours.isOpen;
    }
    ...
    function login() {
        ...
        if (username === 'maiyosa' && password === '170845') {
            ...
            checkoutBtn.disabled = cart.length === 0 || customerName.value.trim() === '' || customerPhone.value.trim() === '';
